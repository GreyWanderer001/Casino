...
public:
    ...
    void SetArcadeName(int index, std::string newVar);
    void SetArcadeRent(int index, double newVar);
    void SetArcadePrice(int index, double newVar);
    void SetArcadeType(int index, std::string newVar);
